...
<body>
	...
	<h1 style="color: green; font-size: 50px;" align="center">Congrats, you have done CICD -Repo2 -Test2 </h1>
	<h2 style="color: red;font-size: 30px" align="center">Your web application is successfully deployed...</h2>
	<h2 style="color: red;font-size: 20px" align="center">- Welcome  to CICD -Repo2 -Test2</h2>
</body>
</html>
